...
export default function ResumeAbout(props) {
    return (
        <React.Fragment>
            ...
            <p>In my most recent roles, I've led design teams to produce beautiful and intuitive experiences that are functional and accessible, on the back of research and testing. </p>
